...
<%@ page contentType="text/html; charset=ISO-8859-1" isELIgnored="false"%>
 ...
 <div class="main">
     <div class="register">
         <h2>Register Here</h2>
         <form:form id="register" action="adddoctor" method="post" modelAttribute="doc">
             <label>Name : </label>
             <br>
             ...
             <br>
             &nbsp;&nbsp;&nbsp;
             <input type="radio" name="status" id="available" path="status" value="Available" required="required">
             &nbsp;
             <span id="available">Available</span>
             &nbsp;&nbsp;&nbsp;&nbsp;
             <input type="radio" name="status" id="not available" path="status" value="Not Available" required="required">
             &nbsp;
