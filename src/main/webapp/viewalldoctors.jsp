...
<c:forEach items="${doclist}" var="emp">

<tr>

<td> <c:out value="${emp.did}"></c:out>   </td>
...
<a href='<c:url value='deletedoc?id=${emp.did}'></c:url>'>Delete</a>&nbsp;&nbsp;
<a href='<c:url value='viewempbyid?id=${emp.did}'></c:url>'>View</a>&nbsp;&nbsp;
